...
app = Flask(__name__)
app.secret_key = os.getenv("SECRET_KEY", "una_clave_secreta_por_defecto")


app.config['MYSQL_HOST'] = os.getenv("MYSQL_HOST", "sql.freedb.tech")
app.config['MYSQL_USER'] = os.getenv("MYSQL_USER", "freedb_inticlark")
app.config['MYSQL_PASSWORD'] = os.getenv("MYSQL_PASSWORD", "Hau*z2468NyfxHb")
app.config['MYSQL_DB'] = os.getenv("MYSQL_DB", "freedb_fotos-shanty")
